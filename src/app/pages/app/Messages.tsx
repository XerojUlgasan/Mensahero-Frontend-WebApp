  ...
  return (
    ...
    >
      ...
      <div style={{ ...panelStyle, width: 200 }}>
        ...
        <div style={{ flex: 1 }}>
          {[{ id: 'all', name: 'All Keys' }, ...apiKeys.filter(k => k.status === 'active')].map(
            key => {
      ...
      <div style={{ ...panelStyle, width: 260 }}>
        <p style={sectionTitleStyle}>
          {selectedKeyId === 'all'
            ? 'All Threads'
            : apiKeys.find(k => k.id === selectedKeyId)?.name ?? 'Threads'}
        </p>
        <div
          style={{
            padding: '10px 12px',
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {visibleThreads.length === 0 && (
            <p style={{ color: 'var(--mh-muted)', fontSize: 13, padding: '20px 16px' }}>
              No threads found
            </p>
          )}
          {visibleThreads.map(thread => {
            ...
            return (
              ...
              >
                ...
                <p style={{ color: 'var(--mh-muted)', fontSize: 11 }}>{last.sentAt}</p>
              </button>
            )
          })}
        </div>
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px', display: 'flex', flexDirection: 'column', gap: 12 }}>
          {filteredMessages.length === 0 && (
            <p style={{ color: 'var(--mh-muted)', fontSize: 13, textAlign: 'center', paddingTop: 32 }}>
